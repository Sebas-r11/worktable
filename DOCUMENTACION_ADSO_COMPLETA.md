# DOCUMENTACIÓN COMPLETA — PROYECTO DE GRADO ADSO
## FLEX-OP (Flexible Operations Platform) — ProyectoWorkT
...
Esta documentación se construyó analizando el código fuente del repositorio. Cuando una sección típica de un proyecto de grado (justificación organizacional escrita, actas, objetivos formales del equipo) **no existe en el repositorio**, se indica explícitamente. Solo se documenta lo evidenciado en código, configuración, pruebas o scripts.

### Elementos analizados

| Área | Estado en repositorio |
|------|----------------------|
| Estructura de carpetas | ✅ Documentada |
| Modelos Django (22) | ✅ Documentados |
| Vistas / ViewSets (18) | ✅ Documentados |
| URLs / APIs | ✅ Documentadas |
| Formularios Django (`forms.py`) | ❌ **No existen** |
| Templates HTML Django | ❌ **No existen** |
| Formularios frontend (React Hook Form + Zod) | ✅ En páginas Next.js |
| Servicios / Celery | ❌ **No implementados** (solo en requirements) |
| Base de datos / migraciones | ✅ Documentadas |
| Configuraciones | ✅ `settings.py`, Docker, CI |
| Dependencias | ✅ `requirements.txt`, `package.json` |
| Permisos y roles | ✅ Documentados |
...
7. [Análisis de Requerimientos](#7-análisis-de-requerimientos)
...
18. [Manual Técnico](#18-manual-técnico)
19. [Manual de Usuario](#19-manual-de-usuario)
20. [Funcionalidades Incompletas, Deuda Técnica y Mejoras Futuras](#20-funcionalidades-incompletas-deuda-técnica-y-mejoras-futuras)
...
# 20. Funcionalidades Incompletas, Deuda Técnica y Mejoras Futuras
